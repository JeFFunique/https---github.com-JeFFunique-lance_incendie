    ...
    <div className='dropdown-content'>
       ...
       <Link to='/infos/formation'> <a className='ada' href="#"> Formation
        ...
        <div className='content'>
            <div>
            <h2 className='maintenance'> Spécialiste des Robinets Incendie Armés</h2>
...
Ces plans de sécurité seront adaptés à l’infratructure de 
vos sites(même pour les sites les plus particuliers), 
esthétiques, efficaces et conforme aux normes en 
vigueur.
            ...
            <img src={ria} alt="Lien2" width="500px" />
