    ...
    <div className='dropdown-content'>
       ...
       <Link to='/infos/formation'> <a className='ada' href="#"> Formation
        ...
        <div className='content'>
            <div>
            <h2 className='maintenance'> BlOCS DE SECOURS</h2>
            <p className='content-3'> Dans un premier temps, nous vous proposons de vous établir un devis entièrement  par téléphone, de cette manière vous serez en
possession des éléments de tarif pour prendre votre décision. <br></br> <br></br>
1. Intervention sur tous types, toutes marques de blocs de secours. <br></br> 
2. Interventions sur Paris, Ile de France et l'ensemble du territoire national (Service d'urgence)<br></br>
3. Interventions avec contrat ou sans contrat <br></br>
4. Prix compétitifs et sans mauvaise surprise <br></br>
5. Entreprise Qualifiée pour l'installation des blocs de secours.
            <br></br> <br></br> 
                   </p>
            </div>
