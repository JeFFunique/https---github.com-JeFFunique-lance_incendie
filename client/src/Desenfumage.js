    ...
    <div className='dropdown-content'>
       ...
       <Link to='/infos/formation'> <a className='ada' href="#"> Formation
        ...
        <div className='content'>
            <div>
            <h2 className='maintenance'> Désenfumage</h2>
            <p className='content-3'> Nous vous proposons des systèmes de désenfumage à des prix adaptés à vos besoins. <br></br> <br></br>
            Nous vous proposons des systèmes de désenfumage avec la meilleure qualité et finition 
possible. <br></br> <br></br>

C’est pourquoi nous vous proposons une maintenance de ces systèmes qui va du suivi 
des pièces à détacher jusqu’au remplacement et à la réparation de ces derniers. <br></br> <br></br>

Nos années d’expérience professionnelle pourront vous aider dans le choix et 
l’installation de vos systèmes de désenfumage.
            ...
            <img src={d} alt="Lien2" width="500px" />
